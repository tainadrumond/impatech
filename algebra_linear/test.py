...
from gaussian_elimination import is_basis

print(is_basis([[1, 0],[0, 1]]))
print(is_basis([[1, 2, 3],[0, 1, 4],[5, 6, 0]]))
print(is_basis([[1, 0],[1, 1]]))
print(is_basis([[1, 2],[2, 4]]))
print(is_basis([[1, 2, 3],[0, 1, 4],[0, 0, 0]]))

from gaussian_elimination import get_inverse
print(get_inverse([[1, 0],[0, 1]]))